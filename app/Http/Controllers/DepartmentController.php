...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        $departments = DB::table('department')
            ->leftJoin('division', 'department.division_id', '=', 'division.id')
            ->select('department.id', 'department.name', 'division.name as division_name')
            ->paginate(15);
    ...
    public function create()
    {
        ...
        return view('system-mgmt/department/create', ['divisions' => $divisions]);
    }
