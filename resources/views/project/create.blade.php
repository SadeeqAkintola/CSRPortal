        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('project.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('objective') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="objective" type="text" class="form-control" name="objective" value="{{ old('objective') }}"> </textarea>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="initiative_id">
                                    @foreach ($initiatives as $initiative)
                                        <option value="{{$initiative->id}}">{{$initiative->initiative_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('community') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="community" type="text" class="form-control" name="community" value="{{ old('community') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cost" type="number" class="form-control" name="cost" value="{{ old('cost') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('target_summary') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="town" type="text" class="form-control" name="target_summary" value="{{ old('target_summary') }}">
                        ...
                        <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="country" value="Nigeria">
                        ...
                        <div class="form-group{{ $errors->has('full_location') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="full_location" type="text" class="form-control" name="full_location" value="{{ old('full_location') }}">
                        ...
                        <div class="form-group{{ $errors->has('project_stage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="project_stage" type="text" class="form-control" name="project_stage" value="{{ old('project_stage') }}">
                        ...
                        <div class="form-group{{ $errors->has('target_details') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="target_details" type="text" class="form-control" name="target_details" value="{{ old('target_details') }}"></textarea>
