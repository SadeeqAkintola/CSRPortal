...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="page-title text-center">Report By Plant</h4>
    ...
    <script type="text/javascript">
        $(function () {
            Highcharts.chart('container', {
                title: {
                    text: 'Total spends per plant per year',
                    x: -20 //center
                },
                subtitle: {
                    text: '',
                ...
                tooltip: {
                    valueSuffix: ' Naira spent this year'
                },
                legend: {
                    layout: 'vertical',
                    align: 'right',
                ...
                series: [{
                    ...
                    name: "Ewekoro",
                    data: [0.000000000000, 0.000000000000, 37000000.000000000000, 37000000.000000000000, 40000000.000000000000, 63000000.000000000000, 73000000.000000000000, 115950000.000000000000, 116740000.000000000000, 130000000.000000000000, 108400000.000000000000, 125000000.000000000000, 228000000.000000000000]
                }, {
                    name: "Mfamosing ",
